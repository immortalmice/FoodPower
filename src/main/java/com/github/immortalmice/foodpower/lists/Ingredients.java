...
class IngredientRegistry{
	...
	public static final RegistryObject<Item> OBJ_MINT = IngredientRegistry.register("mint", (str) -> new Ingredient(str, 1, 0.1f, FoodTypes.SWEET, FlavorTypes.ICE, 1.9));
	public static final RegistryObject<Item> OBJ_FERMENTED_ENDEREYE = IngredientRegistry.register("fermented_endereye", (str) -> new Ingredient(str, 1, 0.1f, FoodTypes.SWEET, FlavorTypes.SWEET, 0.9));
	...
	public static final RegistryObject<Item> OBJ_CHILI = IngredientRegistry.register("chili", (str) -> new Ingredient(str, 1, 0.1f, FoodTypes.VEGETABLE, FlavorTypes.HOT, 0.8));
	...
	public static final RegistryObject<Item> OBJ_CARROT = IngredientRegistry.register("carrot", (str) -> new Ingredient(str, Items.CARROT, FoodTypes.VEGETABLE, FlavorTypes.NONE, 1.25));
	...
	public static final RegistryObject<Item> OBJ_COCOA_BEANS = IngredientRegistry.register("cocoa_beans", (str) -> new Ingredient(str, Items.COCOA_BEANS, FoodTypes.SWEET, FlavorTypes.BITTER, 2.2));
	...
	public static final RegistryObject<Item> OBJ_WATER_BUCKET = IngredientRegistry.register("water_bucket", (str) -> new Ingredient(str, Items.WATER_BUCKET, FoodTypes.NONE, FlavorTypes.ICE, 1.8));
	...
	public static final RegistryObject<Item> OBJ_KELP = IngredientRegistry.register("kelp", (str) -> new Ingredient(str, Items.KELP, FoodTypes.VEGETABLE, FlavorTypes.BITTER, 1.75));
	...
	public static final RegistryObject<Item> OBJ_MAGMA_CREAM = IngredientRegistry.register("magma_cream", (str) -> new Ingredient(str, Items.MAGMA_CREAM, FoodTypes.SWEET, FlavorTypes.BITTER, 0.8));
