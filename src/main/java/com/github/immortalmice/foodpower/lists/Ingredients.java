...
class IngredientRegistry{
	...
	public static final RegistryObject<Item> OBJ_HONEY_BOTTLE = IngredientRegistry.register("honey_bottle", (str) -> new Ingredient(str, Items.field_226638_pX_, FoodTypes.SEASONING, 1.9));
